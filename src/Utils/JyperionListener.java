...
public class JyperionListener implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		Utils.ReadingPropertiesFile data = null;
		try {
			data = new Utils.ReadingPropertiesFile("./ReadFrom/config.properties");
		...
		try {
				Utils.ScreenCapture.getFullScreenShot(Utils.WebDriverFactory.Driver_Path(data.GetBrowser(),"./WebDriver/"), "./screenshot/MyFailImage" + TimeStamp + ".png");

			//	Utils.ScreenCapture.getFullScreenShot(Utils.WebDriverFactory.HeadlessDriver(data.GetBrowser()), "./screenshot/MyFailImage" + TimeStamp + ".png");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
